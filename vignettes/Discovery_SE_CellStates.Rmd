...
Following the identification of SE-specific cell states, spatial ecotypes can be recovered in held-out single-cell datasets (e.g., scRNA-seq or single-cell spatial transcriptomics) using the model derived in [Tutorial 3](TrainRecoveryModel.html). The recovered spatial ecotypes can then be validated by assessing the co-occurrence of cell states within each SE, as described in [Tutorial 5](Recovery_scST.html) and [Tutorial 6](Recovery_scRNA.html), focusing on SE-specific cell state assignments.
