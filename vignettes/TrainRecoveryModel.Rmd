...
Using the SE recovery model, users can recover spatial ecotypes from held-out single-cell datasets, including both single-cell spatial transcriptomics and single-cell RNA-seq data, as demonstrated separately in [Tutorial 5](Recovery_scST.html) and [Tutorial 6](Recovery_scRNA.html).
