...
You can visualize the results using the [CooccurrenceHeatmapView](../reference/CooccurrenceHeatmapView.html) function, as described in the [Tutorial 5](Recovery_scST.html).
